...
void setDirection() {  // motor turns with/counter control-knob's direction. Must be run before updateState()
  if (reverseMode) {
...
void updateInputs() {  // updateInputs() and subtract to get int differential
  ...
  setDirection();  // Set motor direction, must be run before updateState()
